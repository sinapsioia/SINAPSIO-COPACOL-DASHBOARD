...
- La edición manual de teléfono/dirección desde la ficha usa `copacol_client_contact_overrides`. Ejecutar `supabase_contact_overrides.sql` una vez en Supabase SQL Editor para que los datos corregidos sobrevivan a las cargas de Siigo.
